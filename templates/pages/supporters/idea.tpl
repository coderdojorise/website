...
<div class="heading-banner-container banner-inverse heading-purple">
	<div class="heading-banner">
		<h1>iDEA</h1>
		<h2>The Duke of York Inspiring Digital Enterprise Award</h2>
	</div>
</div>
...
<div class="container supporters">
	...
	<div class="row">
		<div class="col-md-8">
			<div class="row">
				<div class="col-xs-4">
					<img src="/assets/imgs/logos/idea.png" class="img-responsive" />
				</div>
				<div class="col-xs-8">
		...
		<div class="col-md-4">
			<div class="supporter-contact">
				...
				<ul class="social-links">
					...
					<li>
						<a href="https://twitter.com/idea_award" title="Follow @idea_award on Twitter" target="_blank">
