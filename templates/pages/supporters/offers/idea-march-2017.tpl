...
<div class="heading-banner-container banner-inverse heading-purple">
	<div class="heading-banner">
		<h1>iDEA</h1>
		<h2>March Competition Criteria</h2>
	</div>
</div>
...
<div class="container supporters">
	...
	<p><strong>Award categories are:</strong></p>
		<ul>
			...
			<li>Most Badge points awarded in March.</li>
			<li>Best New Badge idea for iDEA.</li>
			<li>Most Influential individual (using the iDEA Influencer badge, the person who can create the highest number of referrals in the month of March).</li>
			<li>Most Influential individual (using the iDEA Influencer badge, the person who can create the highest number of referrals in any given week in March).</li>
		</ul>

	<p>For any questions or inquries about the criteria or categories, please email us at ideacompetition@coderdojo.london.</p>

	<a href="/assets/imgs/campaigns/idea_march_spread.jpg" target="_blank">
		<img src="/assets/imgs/campaigns/idea_march_spread.jpg" alt="iDEA March Competition CoderDojo Spread" style="max-width: 40%;margin:0 auto" />
	</a>
